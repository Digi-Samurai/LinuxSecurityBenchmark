...
# List of all service check modules
AVAILABLE_CHECKS = [
    '2_1_1',  # Autofs
    '2_1_2',  # Avahi
    '2_1_3',  # DHCP Server
    ...
    '2_1_6',  # FTP Server
    '2_1_7',  # LDAP Server
    '2_1_8',  # Message Access Server
    '2_1_9',  # Network File System
    '2_1_10',  # NIS Server
    '2_1_11',  # Print Server
    '2_1_12',  # Rpcbind
    '2_1_13',  # Rsync
    '2_1_14',  # Samba File Server
    '2_1_15',  # SNMP
    '2_1_16',  # TFTP Server
    '2_1_17',  # Web Proxy Server
    '2_1_18',  # Web Server
    '2_1_19',  # Xinetd
    '2_1_20',  # X Window Services
    '2_1_21',  # Mail Transfer Agent
    '2_1_22',  # Network Services
]
...
def run_all_checks() -> Dict[str, Any]:
    ...
    for check_name in AVAILABLE_CHECKS:
        try:
            ...
            module = importlib.import_module(f'cis_benchmark.Services.Configure_Server_Services.{check_name}')
